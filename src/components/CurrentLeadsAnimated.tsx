...
const Leads: React.FC = () => {
  ...
  return (
    <>
      <div className="  flex  pl-4 md:mt-24  md:pl-[50px] lg:pl-[80px] xl:pl-[90px] 2xl:pl-[130px] ">
        <motion.div
        ...
        >
          <div className="flex flex-col items-center">
            <div
              className="flex h-[30px] w-[30px] items-center justify-center rounded-full bg-[#2CC4F5] bg-gradient-to-b from-[#20FF87] to-[#fff]/30 shadow-dotShadowBlue  transition duration-700 md:h-[41px] md:w-[41px] 
              "
            >
              <div className="h-[12px] w-[12px] self-center rounded-full bg-white"></div>
            </div>
            <div className=" h-full  w-[5px] bg-gradient-to-b from-[#2CC4F5] to-transparent transition duration-700"></div>
          </div>
        </motion.div>
