    ...
    <>
      <div className="flex">
        <div className="flex flex-col items-center">
          <div className="h-[15px] w-[15px] self-center rounded-full bg-white shadow-dotShadowCyan"></div>
        ...
        <div className="mx-auto flex max-w-[1920px]">
          ...
          <div className="flex flex-col">
            <div className="mb-[30px] text-[16px] leading-normal text-white md:text-2xl lg:text-4xl ">
              App Development
            </div>
