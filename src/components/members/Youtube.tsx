  ...
  return (
    <div className="h-[220px] w-full rounded-md md:h-[270px] md:rounded-xl lg:h-[350px] 2xl:h-[400px]">
      ...
      <div
        className={
          isActive
            ? "delay-400 z-10 flex min-h-[105px] w-full -translate-y-[70px] scale-100 transform items-end justify-between rounded-[10px]  bg-[#25252580] p-[5px] pb-[5px] backdrop-blur-[5px] transition  ease-in-out md:pb-[8px] lg:-translate-y-16 2xl:-translate-y-14"
      ...
      >
        <div className="relative flex w-full items-center justify-between">
          ...
          <div className="rounded-lg p-1 text-[12px] font-normal capitalize leading-none  text-white lg:text-[16.5px] 2xl:text-[20px]">
            {into.name}
          </div>
    ...
    <div className="flex ">
      ...
      <div className="mx-auto flex max-w-[1920px]">
        ...
        <div className="flex flex-col">
          <div className="mb-[30px] text-[16px] font-normal leading-normal text-transparent text-white md:text-2xl lg:text-3xl ">
            Home
          </div>
