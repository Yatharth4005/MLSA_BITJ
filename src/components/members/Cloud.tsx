  ...
  return (
    <div className="flex ">
      <div className="flex flex-col items-center px-2 md:px-0">
        <div className="h-[15px] w-[15px] self-center rounded-full bg-white shadow-dotShadowBlue2"></div>

        <div className="h-full w-[5px]  bg-gradient-to-b from-[#3BABCF] to-transparent transition duration-700 "></div>
      </div>
      <div className="mx-auto flex max-w-[1920px]">
        <div className="ml-[5px] sm:ml-[10px] md:ml-[40px] lg:ml-[70px]"></div>
        <div className="flex flex-col">
          <div className="mb-[30px] text-[16px] font-semibold leading-normal text-white md:text-2xl lg:text-3xl ">
            Cloud
          </div>
