                    ...
                    {EVENTS2023.map((event, index) => {
                        ...
                        return (<>
                            ...
                            <div key={index} className="relative group gallery-gradient overflow-hidden rounded-[20px] md:rounded-[4px]  w-full h-[300px] sm:h-[22vw] lg:h-[19.21vw] 3xl:h-[369px]">
                                ...
                                {<Image src={event} width={555} height={355} className="block z-10 w-full h-full object-cover object-center transition duration-700 " alt="gallery"></Image>}

                                <div className="absolute bottom-16 left-4 z-40 text-white text-xl 3xl:text-3xl font-normal ">{event}</div>
                                <div className="absolute bottom-9 left-4 z-40 text-white text-base 3xl:text-3xl font-normal ">{event}</div>
                                <div className="absolute bottom-4 left-4 z-40 text-white text-base 3xl:text-3xl font-normal ">{event}</div>
                            </div>
                        ...
                        return (<>
                            {check == true ? (
                                <div key={index} className="relative group gallery-gradient overflow-hidden rounded-[20px] md:rounded-[7px]  w-full h-[300px] sm:h-[22vw] lg:h-[19.21vw] 3xl:h-[369px]">
                                    ...
                                    <Image src={event} width={555} height={355} className="block z-10 w-full h-full object-cover transition duration-700 " alt="gallery"></Image>

                                    <div className="absolute bottom-16 left-4 z-50 text-white text-xl 3xl:text-3xl font-normal ">{event}</div>
                                    <div className="absolute bottom-9 left-4 z-50 text-white text-base 3xl:text-3xl font-normal ">{event}</div>
                                    <div className="absolute bottom-4 left-4 z-50 text-white text-base 3xl:text-3xl font-normal ">{event}</div>
                                </div>) : (<></>)
                            }
