    ...
    <div className="h-full">
      <div className="h-full overflow-x-hidden ">
        <div className=" teams-gradient min-h-[90vh] p-[5px] flex items-center justify-center w-[100vw] relative">
          ...
          <Image src="/comingsoon.jpg" width={3000} height={100} alt="members" className="no-repeat absolute top-0 bottom-0 left-0 right-0 h-[88vh] w-full bg-cover object-cover bg-center bg-no-repeat"></Image>
